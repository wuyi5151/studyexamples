...
<body>
    <div id="header">
        <a id="home" href="javascript:;" class="ui-shadow ui-btn ui-corner-all ui-btn-inline ui-btn-icon-left ui-icon-home ui-btn-left" style="margin: 0;">首页</a>
        用户详情
    </div>
    <h1 style="margin-top: 1.02rem;">当前用户为<?php echo $this->session->userinfo->username;?></h1>
    <h2>订单列表</h2>

    <table data-role="table" data-mode="columntoggle" class="ui-body-d ui-shadow table-stripe ui-responsive" data-column-btn-theme="a" data-column-popup-theme="a" data-column-btn-text="选择显示的列">
        <thread>
            <tr class="ui-bar-a">
